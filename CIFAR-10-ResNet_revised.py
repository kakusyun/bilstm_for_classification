...
from network.resnet import resnet_v1_rev1, resnet_v2, resnet_v1_rev2
...
def main():
    ...
    if version == 2:
        ...
        model = resnet_v1_rev1(input_shape=input_shape, depth=depth, num_classes=num_classes)
    #
    # if version == 2:
...
if __name__ == '__main__':
    ...
    model_type = 'ResNet_Rev'  # Todo: Important
